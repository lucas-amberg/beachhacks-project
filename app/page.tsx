  ...
  return (
    <div className="flex flex-col justify-center items-center h-[calc(100vh-80px)]">
      <Card className="w-full max-w-lg">
        <CardHeader>
          <CardTitle className="text-3xl text-center">Study Materials Manager</CardTitle>
        ...
        <CardContent>
          <div className="flex flex-col items-center space-y-4 text-center">
            ...
            <p className="text-lg">
              Select a study set from the sidebar to view and manage your study materials.
            </p>
            <p>
              You can upload PDFs, PowerPoint presentations, Word documents, and images to keep all your
